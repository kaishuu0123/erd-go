...
func templatesDot_relationsTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dot_relations.tmpl", size: 821, mode: os.FileMode(436), modTime: time.Unix(1571059917, 0)}
...
func templatesDot_tablesTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/dot_tables.tmpl", size: 1001, mode: os.FileMode(436), modTime: time.Unix(1571059917, 0)}
